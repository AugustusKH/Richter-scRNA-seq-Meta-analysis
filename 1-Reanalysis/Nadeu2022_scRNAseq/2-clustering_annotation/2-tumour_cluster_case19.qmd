...
As cluster 0 and 4 have the same CXCR4 expression pattern (upregulation) while cluster 1 and 2 have the same trend (downregulation), we will group them into two main clusters.

Moreover, clusters 3 and 6 have no distinctive markers as fold changes are very small:
