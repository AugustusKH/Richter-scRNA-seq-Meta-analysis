...
# Save
ggsave(
  filename = here::here("reanalysis/results/plots/04-rt_seed_cells_supplementary.pdf"),
  plot = fig,
  device = cairo_pdf,
  width = 21, 
  height = 23, 
...
write_delim(
  pct_seed_cells_df,
  file = here::here("reanalysis/results/plots/04-rt_annotation_and_seeds_number_of_cells_supplementary.csv"),
  delim = ";"
)
