...
# Save
ggsave(
  filename = here::here("reanalysis/results/plots/01-rt_annotation_and_seeds.pdf"),
  plot = fig,
  device = cairo_pdf,
  width = 21, 
  height = 11, 
...
write_delim(
  pct_seed_cells,
  file = here::here("reanalysis/results/plots/rt_annotation_and_seeds_number_of_cells.csv")
)
