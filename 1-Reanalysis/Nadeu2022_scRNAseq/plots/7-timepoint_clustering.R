...
# Load data
path_to_obj <- here::here("reanalysis/results/R_objects/7.seurat_time_point_specific_list.rds")
...
# Save
ggsave(
  filename = here::here("reanalysis/results/plots/07-rt_time_point_specific_clustering_supplementary.pdf"),
  plot = fig,
  device = cairo_pdf,
  width = 21, 
  height = 19, 
...
ggsave(
  filename = here::here("reanalysis/results/plots/legends/07-rt_time_point_specific_clustering_supplementary_legend.pdf"),
  plot = leg,
  device = cairo_pdf,
  width = 12, 
  height = 4, 
