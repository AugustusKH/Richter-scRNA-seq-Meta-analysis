...
# Save
ggsave(
  filename = here::here("reanalysis/results/plots/rt_annotation_supplementary.pdf"),
  plot = fig,
  device = cairo_pdf,
  width = 21, 
  height = 28, 
...
walk(names(seurat_list), function(x) {
  ggsave(
    filename = str_c(here::here("reanalysis/results/plots/legends/rt_annotation_supplementary_legend_annotation_"), x, ".pdf", sep = ""),
  ...
  ggsave(
    filename = str_c(here::here("reanalysis/results/plots/legends/rt_annotation_supplementary_legend_tissue_"), x, ".pdf", sep = ""),
  ...
  ggsave(
    filename = str_c(here::here("reanalysis/results/plots/legends/rt_annotation_supplementary_legend_dotplot_"), x, ".pdf", sep = ""),
