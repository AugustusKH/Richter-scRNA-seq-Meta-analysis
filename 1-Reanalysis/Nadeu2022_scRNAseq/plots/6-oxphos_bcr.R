...
gene_sets_list <- readRDS(here::here("reanalysis/results/4_differential_expression/tmp/gene_sets_gsea_analysis.rds"))
...
# Save
ggsave(
  filename = here::here("reanalysis/results/plots/06-rt_oxphos_and_bcr_scRNA_supplementary.pdf"),
  plot = fig,
  device = cairo_pdf,
  width = 21, 
  height = 29, 
...
ggsave(
  filename = here::here("reanalysis/results/plots/legends/06-rt_oxphos_and_bcr_scRNA_supplementary_legend_violins.pdf"),
  plot = legend_violins,
  device = cairo_pdf,
  width = 4, 
  height = 1, 
